...
/**
 * MigrationsParametersFixture
 *
 */
class MigrationsParametersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'migration_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'migration_id' => ['type' => 'unique', 'columns' => ['migration_id', 'task_id', 'parameter_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
